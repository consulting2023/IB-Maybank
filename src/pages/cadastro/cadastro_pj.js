...
export default class CadastroPj extends Component {
  ...
  agCadastro = () => {
    ...
    Funcoes.Geral_API(data).then((res) => {
      console.log(res);
      if (process.env.NOME_BANCO == "B4+") {
        if (res[55].id == 56) {
          console.log(res[55]);
          this.setState({ agencias: res[55] });
        } else {
      ...
      return (
        <div className="login">
            ...
            <div className="cadastropj select-none d-flex align-items-center">
              <div className="w-100">
                <span style={{ color: "white" }}>
                  (Aperte Enter dentro da caixa de texto para cadastrar a
                  informação pedida.)
                </span>
                {this.state.cadastroPt1 && (
                  <>
                    ...
                    <Select
                      options={
                        process.env.NOME_BANCO === "B4+"
                          ? this.state.agencias &&
                            typeof this.state.agencias === "object"
                            ? [
                                {
                                  value: this.state.agencias.id,
                                  label: this.state.agencias.nome, // Exibe o nome da agência no dropdown
                                  number: this.state.agencias.numero,
                                },
                              ]
                            : []
                          : Array.isArray(this.state.agencias)
                      ...
                      <div className="mt-3">
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            this.setState({
                              celEmpresa:
                                numericValue.length > 0 ? formattedValue : "",
                            });
                          }}
                          onKeyDown={(e) => {
                            ...
                            if (cel.length > 0 && e.key === "Enter") {
                              if (cel.length > 13) {
                                ...
                                alert(
                                  "Por favor, termine de digitar o telefone."
                                );
                              }
                            }
                          }}
                      ...
                      <div className="mt-3">
                        ...
                        <Select
                          options={[
                            ...
                            {
                              label: "Empresário Individual - SOLE_PROPRIETOR",
                            ...
                            {
                              label: "Sociedade de Conta de Participação - SCP",
                              value: "SCP",
                            },
                            {
                            ...
                            {
                              label: "Sociedade de Propósito Específico - SPE",
                              value: "SPE",
                            },
                  ...
                  <>
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        this.setState(
                          { dataAbertura: e.target.value, liberarCnae: true },
                          () => {
                    ...
                    {this.state.liberarEnderecoCompleto && (
                      <div className="mt-3">
                        <span className="ttAgencia">Endereço</span>
                    ...
                    {this.state.liberarComprovante && (
                      <div className="mt-3">
                        <span className="ttAgencia">
                          Agora precisamos do comprovante de endereço da empresa
                          em PNG ou JPG.
                        </span>
                ...
                {this.state.cadastroPt4 && (
                  <>
                    ...
                    {this.state.liberarContrato && (
                      <div className="mt-3">
                        <span className="ttAgencia">
                          Agora, precisamos de seu contrato social ou sua ultima
                          alteração. Por favor, faça o upload do arquivo, em PDF
                          ou tire foto de todas as páginas.
                        </span>
                ...
                {this.state.cadastroPt5 && (
                  <>
                    ...
                    {this.state.liberarRepCelular && (
                      <div className="mt-3">
                        <span className="ttAgencia">
                          Por favor, informe o número de celular do
                          Representante.
                        </span>
                ...
                {this.state.cadastroPt6 && (
                  <>
                    ...
                    {this.state.liberarSenha2 && (
                      <div className="mt-3">
                        <span className="ttAgencia">Repita a senha</span>
                    ...
                    {this.state.liberarRepData && (
                      <div className="mt-3">
                        <span className="ttAgencia">
                          Por favor, informe a data de nascimento do
                          Representante.
                        </span>
                    ...
                    {this.state.liberarRepGenero && (
                      <div className="mt-3">
                        <span className="ttAgencia">Escolha o gênero</span>
                ...
                {this.state.cadastroPt7 && (
                  <>
                    ...
                    <span className="ttAgencia">Informe seu estado civil</span>
                    ...
                    {this.state.liberarRepTipodoc && (
                      <div className="mt-3">
                        <span className="ttAgencia">
                          Precisamos da foto de um documento. Qual documento
                          você usará para abrir sua conta?
                        </span>
                          ...
                          <Button
                            ...
                            onClick={() => {
                              ...
                              this.setState({
                                ...
                                rep_docestado: "",
                                rep_passpais: "",
                                rep_passnacionalidade: "",
                                rep_passnaturalidade: "",
                                rep_passvalidade: "",
                              });
                            }}
                          >
                ...
                {this.state.cadastroPt8 && (
                  <>
                      ...
                      onKeyDown={(e) => {
                        ...
                        if (numero.length > 0 && e.key === "Enter") {
                          if (this.state.rep_tipodoc == "1") {
                            this.salvarDormente(
                              "representante_numerorg",
                              numero
                            );
                          } else if (this.state.rep_tipodoc == "2") {
                            this.salvarDormente(
                              "representante_numercnh",
                              numero
                            );
                      ...
                      <div className="mt-3">
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            if (this.state.rep_tipodoc == "1") {
                              this.salvarDormente(
                                "representante_datarg",
                                e.target.value + " 00:00:00"
                              );
                              this.setState({ liberarRepDocOrgao: true });
                            } else if (this.state.rep_tipodoc == "2") {
                              this.salvarDormente(
                                "representante_datacnh",
                                e.target.value + " 00:00:00"
                              );
                              this.setState({ liberarRepDocOrgao: true });
                            } else if (this.state.rep_tipodoc == "3") {
                      ...
                      <div className="mt-3">
                        ...
                        <Select
                          ...
                          onChange={(selectedOption) => {
                            ...
                            if (this.state.rep_tipodoc == "1") {
                              this.salvarDormente(
                                "representante_orgaorg",
                                selectedOption.label
                              );
                            } else if (this.state.rep_tipodoc == "2") {
                              this.salvarDormente(
                                "representante_orgacnh",
                                selectedOption.label
                              );
                            }
                          }}
                    ...
                    {this.state.liberarRepPassNatu && (
                      <div className="mt-3">
                        <span className="ttAgencia">Insira a naturalidade</span>
                  ...
                  <>
                    ...
                    <div>
                      <ul className="ml-2">
                        ...
                        <li>
                          -Não estar usando boné, chapéu ou quaisquer adereços
                          que interfiram em seu rosto.
                        </li>
                    ...
                    {this.state.liberarRepComprovante && (
                      <div className="mt-3">
                        <span className="ttAgencia">
                          Agora precisamos do seu comprovante de residência em
                          PNG ou JPG.
                        </span>
                ...
                {this.state.cadastroPt10 && (
                  <>
                    ...
                    <span className="ttAgencia">Informe seu CEP.</span>
                    ...
                    {this.state.liberarRepEnderecoCompleto && (
                      <div className="mt-3">
                        <span className="ttAgencia">Endereço completo</span>
                    ...
                    {this.state.liberarRepPolitico && (
                      <div className="mt-3">
                        <span className="ttAgencia">
                          Você é uma pessoa politicamente exposta? Fique
                          tranquilo, isso não impossibilita sua abertura de
                          conta.
                        </span>
          ...
          >
            ...
            <Modal.Body>
              <Container>
                <span className="ttAgencia">CEP</span>
                <input
                ...
                <br />
                <br />
                <span className="ttAgencia">Número</span>
                <input
                ...
                <br />
                <br />
                <span className="ttAgencia">Complemento</span>
                <input
                ...
                <br />
                <br />
                <span className="ttAgencia">Bairro</span>
                <input
                ...
                <br />
                <br />
                <span className="ttAgencia">Cidade</span>
                <input
                ...
                <br />
                <br />
                <span className="ttAgencia">Estado</span>
                <input
