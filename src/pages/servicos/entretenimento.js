...
export default class Entretenimento extends Component {
    constructor() {
        super();
        ...
        this.state = {
            ...
            operadoras:
            {
                ...
                img: [
                    Objetos.entretenimento1,
                    Objetos.entretenimento2,
                    Objetos.entretenimento3,
                    Objetos.entretenimento4,
                    Objetos.entretenimento5,
                    Objetos.entretenimento6,
        ...
        return (
            <>
                <section>
                    ...
                    <p className="pageTitulo">Serviços</p>
                    <BannerTitle title={i18n.t("Serviços")} img={Objetos.servicoImg}/>

                    <Container>
                        <Row>
                            <Col className="col-12">
                                {/* <h3>Recarregue seus serviços de entretenimento de forma fácil e rápida.</h3> */}
                                <h3>{i18n.t('servicos.recarregaSer')}</h3>
                                <hr />
                            </Col>
                        </Row>
                    </Container>
