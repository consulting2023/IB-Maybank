                ...
                return (
                    <>
                        ...
                        < Container className="mt-1 col-md-10 text-center" >
                            <p className="text-center" style={{ fontSize: '1.65em' }}>{i18n.t('transferencia.titleLote')}</p>
                        </Container >
                        ...
                        <Container className="blocoPesquisaExt mt-4 col-md-10 d-flex justify-content-center"  >
                            <Col>
                                ...
                                {this.state.loading ? (
                                    <ReactLoading className='float-right' type={'bubbles'} color={'#000'} height={'5%'} width={'5%'} />
                                ) : (
                                    <button disabled={this.state.loading}
                                        onClick={() => { this.validarArq() }}
                                        className="btn verMultiBoletos btn-sm btn-success">{i18n.t('transferencia.btnVerificarLote')}</button>
                                )}

                                <button type="button" className="btn download_csv btn-sm btn-success  float-left" onClick={() => this.download_file()} >{i18n.t('transferencia.btnDownLote')}</button>
                        ...
                        >
                            <Modal.Body className="modalValidacao">
                                ...
                                <Container>
                                    ...
                                    <Row className="justify-content-center">
                                        {this.state.loading ? (
                                            <ReactLoading className='float-right' type={'bubbles'} color={'#000'} height={'25%'} width={'25%'} />
                                        ) : (
