...
export default class BoletoCobranca extends Component {
  ...
  boletos_lista = () => {
    ...
    Funcoes.Geral_API(data, true).then((res) => {
      ...
      if (keys.length === 0) {
        ...
        let numero2_aux = 10;
        this.setState({
          cortarBoleto: array_cortar_aux.slice(numero1_aux, numero2_aux),
        });
  ...
  colorStatus = (status, vencimento) => {
    ...
    if (
      status === 0 &&
      Formatar.formatarDateGerenciadorBoletosComparativo(vencimento) >=
        data_atual
    ) {
      return "#41a8d8";
    } else {
  ...
  paginacao = (numero) => {
    let array_cortar = [];
    this.state.boleto.map((dados) => array_cortar.push(dados));
  ...
  render() {
    return (
      <div>
        <BannerTitle
          title={i18n.t("deposito.deposito")}
          img={Objetos.depositoImg}
        />
        <Container className="p-3 d-flex justify-content-center">
          <Col md={8} className="baseWindow px-5 py-4">
            <Row>
              ...
              >
                <strong>Opções de depósito:</strong>
              </p>
            </Row>
            <Row className="text-center px-3">
                  ...
                  <Row className="w-80 m-auto">
                    ...
                    <Col xs={7} className="px-0 my-auto">
                      <p className="buttonTitle m-auto">
                        {i18n.t("deposito.btnDepositoBoleto")}
                      </p>
                    </Col>
                  </Row>
                </Button>
                ...
                <Link to="/gerenciar_deposito">
                  ...
                  >
                    <Row className="w-80 m-auto">
                      ...
                      <Col xs={7} className="px-0 my-auto">
                        <p className="buttonTitle m-auto">
                          {i18n.t("deposito.btnDepositoGerenciar")}
                        </p>
                      </Col>
                    </Row>
                  </Button>
              ...
              <Col className="p-3">
                <Button
                  ...
                  className="baseButtonPrimary"
                  onClick={() => {
                    this.setState({ transferenciaShow: true });
                  }}
                >
                  <Row className="w-80 m-auto">
                    <Col xs={5} className="m-auto px-0">
                    ...
                    <Col xs={7} className="px-0 my-auto">
                      <p className="buttonTitle m-auto">
                        {i18n.t("deposito.btnDepositoTED")}
                      </p>
                    </Col>
                  </Row>
                </Button>
              ...
              <Col className="p-3">
                ...
                >
                  <Row className="w-80 m-auto">
                    ...
                    <Col xs={7} className="px-0 my-auto">
                      <p className="buttonTitle m-auto">
                        {i18n.t("deposito.btnDepositoComprovante")}
                      </p>
                    </Col>
                  </Row>
                </Button>
        ...
        <Modal
          ...
          animation={false}
          size="sm"
          show={this.state.boletoShow}
          onHide={() => (window.location.href = "/deposito")}
        >
          <Modal.Body>
            <div>
              {this.state.loading ? (
        ...
        <Modal
          centered
          animation={false}
          show={this.state.transferenciaShow}
          onHide={() => (window.location.href = "/deposito")}
        >
          <Modal.Body>
            <p>
              <strong>
                {" "}
                {i18n.t("deposito.textTED") + process.env.NOME_BANCO}
              </strong>
            </p>
            <hr></hr>
            <Alert variant={"success"}>
              <div style={{ color: "black" }}>
                CNPJ: {process.env.CNPJ_BANCO}
                <br></br>
                Nome: {process.env.RAZAO_NOME}
                <br></br>
                Banco: {process.env.BANCO_BANCO}
                <br></br>
                Agência: {process.env.AGENCIA_BANCO}
                <br></br>
                Conta Corrente: {process.env.CONTA_BANCO}
                <br></br>
              </div>
            </Alert>
            <hr></hr>
        ...
        >
          <Modal.Body>
            <p>
              <strong>{i18n.t("deposito.textComp")}</strong>
            </p>
            <div>
              <div className="form-group">
                <Row className="custom-file-caixa">
                  <label className="custom-file-upload">
                    <input
                      type="file"
                      onChange={(event) => this.receberComprovante(event)}
                    />
