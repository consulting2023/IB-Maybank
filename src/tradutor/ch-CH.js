...
export default {
  ...
  login: {
    ...
    abra_o_aplicativo: '打开 %{banco} 应用程序，使用您的帐户登录，然后在应用程序上的 Access Key 按钮上，您将找到 Token 和 QRCode 以验证 Access Key 以进入网上银行',
    token: '令牌',
  ...
  cobranca: {
    ...
    funcLiberada: '您没有释放此功能，请通过以下方式联系我们: %{email_banco} %{telefone_banco}',
    digiteValor: '输入金额',
    ...
    escolhaCSV: '请选择CSV文件',
    nenhumFavorecido: '您没有注册任何收款人，要生成您的付款单，请先注册一个收款人',
    cobranca: '收款'
  },
  ...
  transferencia: {
    ...
    erroNumero: '此号码未找到帐户',
    erroDoc: '此证件找到帐户',
    funcionalidade: '您没有释放此功能，请通过以下方式联系我们: %{email_banco} %{telefone_banco}',
    formatoInvalido: '无效的文件格式',
    escolhaCSV: '选择CSV文件',
    erroCSV: 'CVS 文件错误，请查看: %{erroMsg}',
  ...
  escolha_cartao: {
    ...
    detalhes: '详情',
    aquisicao: '• 键获取所有优势!',
    aquisicaoDesc: '申请银行 %{nome_banco} 卡收费为 R$ %{tarifa} 要有余额才可直接在账户里面扣取',
    // aquisicaoDesc2: '收费为 R$ %{tarifa}',
    // aquisicaoDesc3: '要有余额才可直接在账户里面扣取',
    selecao: '选择银行 %{nome_banco} 卡的颜色',
    termos: '请阅读使用条款',
    confirme: '激活您的 %{nome_banco} 卡请确认数据:',
    // confirme2: '请确认数据: ',
    nome: '名字: ',
    telefone: '电话: ',
    textoDescricao: '数据若有错误，请联系我们在这封电子邮件中 %{email_banco}',
    // textoDescricao1: '数据若有错误，请联系我们 ',
    // textoDescricao2: ' 否 ',
    token: '已通过手机短信传验证码，请输入验证码',
    instrucao: '输入卡号，在卡号上方，有效期下方',
    digite: '请填写 %{nome_banco} 卡的最后4个尾数',
    crieSenha: '帮您的 %{nome_banco} 卡建立4个数字的密码',
    desbloqueio: '恭喜您，您的 %{nome_banco} 卡已解锁成功！',
    // desbloqueio1: '恭喜您，您的卡 ',
    // desbloqueio2: ' 已解锁成功！',
    carregar: '想要如何存值您的卡？',
    transferencia: '转账',
    boleto: '生成付款单来存值您的卡',
    valorBoleto: '付款单的金额',
    vencimento: '截止日',
    transferenciaRapida: '银行卡的之间转账',
    codigo: '请输入 卡的识别码，在截止日的下方',
    mostrarValor: 'Quanto deseja transferir para %{nome_cartao} ?',
    valor: '金额 R$',
    senha: '密码',
    boletoGerado: '生成付款单成功！',
    pagador: '付款人',
    nossoNumero: '我们的号码',
    emissao: '生成日',
    validade: '截止日',
    codigoBarras: '条码',
    bloquear: '这里您可以封锁 或者 解锁您的 %{nome_banco} 卡',
    cartao: '卡: ',
    id: 'ID: ',
    status: '状态: '
  },
