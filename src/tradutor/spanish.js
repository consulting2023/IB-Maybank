...
export default {
  ...
  extrato: {
    alertaCartao: "No tienes una tarjeta activa.",
    btnExtratoDigital: "Cuenta Digital",
    btnExtratoCartao: "Tarjeta",
    btnExtratoConvenio: "Convenio",
    btnExtratoInvestimento: "Inversión",
    btnExtratoParcelado: "Pago a Plazos",
    btnExtratoAgenda: "Agenda Financiera",
    modalCartaoAtivo: "No tienes una tarjeta activa.",
    fecharModal: "Cerrar",
    breadCrumb1: "Inicio",
    breadCrumb2: "Extracto",
    breadCrumb3: "Extracto de la Cuenta",
    textoEscolhaExtrato: "Elija el período que desea ver en su extracto:",
    dataInicio: "Fecha Inicial:",
    dataFinal: "Fecha Final:",
    btnPesquisar: "Buscar",
    downloadPdf: "Descargar Extracto PDF",
    downloadCsv: "Descargar Extracto CSV",
    descr: "Descripción",
    descrValor: "Valor €",
    descrData: "Fecha",
    descrNome: "%{descricao}",

    nenhumEncontrado: "No se encontraron movimientos en la fecha seleccionada",
    extrato: "Extracto",
    nenhumLancamento: "No se encontraron lanzamientos",
  },
  ...
  cobranca: {
    ...
    vencido: "Vencido",
    emAberto: "Pendiente",
    pagoEm: "Pagado: %{dataPago}",
    pago: "Pagado",
    nenhumBoleto: "No se encontraron boletos",
    dataFinal: "Fecha Final",
    nenhumArquivo: "No se encontraron archivos",
    formatoInvalido: "Formato de archivo inválido",
    erroCSV: "CSV con error, verifique: %{erroMsg}",
    analiseCSV: "CSV en análisis, siga en Gestionar Lotes",
    escolhaCSV: "Seleccione un archivo CSV",
    nenhumFavorecido:
      "No tiene ningún beneficiario registrado. Registre uno para generar su boleto.",
    cobranca: "Cobro",
  },
