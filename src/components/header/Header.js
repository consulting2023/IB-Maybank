...
import { Navbar, Container, Modal, Row, Image, Col, Button, Dropdown } from "react-bootstrap";
...
export default class Header extends Component {
  ...
  SaldoConta = () => {
    ...
    Funcoes.Geral_API(data, true).then((res) => {
      ...
      if (Produtos.saldoDigital) tmpSaldos.digital = ({ id: '1', show: false, icone: Icones.saldo1, titulo: i18n.t('home.saldoDigital'), saldo: Formatar.formatarMoeda(res.digital), saldoTrue: res.digital });
  ...
  listar_msg = () => {
    const dados = {
      ...
      data: { 'data_de': format(new Date(), 'yyyy-MM-dd'), 'data_ate': format(new Date(), 'yyyy-MM-dd'), 'conta_id': this.state.pessoa.conta_id },
      method: 'POST',
    };
                ...
                <ul className="navbar-nav align-items-center">
                  ...
                  <li className="nav-item mx-1">
                    { this.state.saldos.digital ?
                      <div className="saldosWrapper">
                        <Button className="saldosBtn btn-light w-100 p-1" onClick={() => this.setBlur()}>
                                ...
                                <Row className="saldosHome justify-content-center">
                                  <p className="text-nowrap texto-saldos select-none">
                                    {/* {this.state.saldos.digital.titulo} */}
                                    {
                                      ...
                                      (i18n.t('home.saldoDigital')) : 'var_error'
                                    }
                                  </p>
                                </Row>

                                <Row className="justify-content-center">
                                  <span className={'texto-saldos select-none saldoValor ' + (this.state.saldos.digital.show ? 'deblurred' : null)} >
                       ...
                       : 
                      <div className="saldosWrapper">
                        <ReactLoading type={'spin'} className="p-2 m-auto d-block"/>
                      </div>
                    }
                  </li>
                        ...
                        <Container className="textoOverlay cursor-pointer justify-content-center position-relative">
                          ...
                          <Col xs={8} className="px-2">
                            <p className="text-left usuario">
                              ...
                              <br />
                              {pessoa.mostrar && i18n.t('header.empresa') + pessoa.razao_social}
                            </p>
                          </Col>
                          <span className="p-2 px-3 mt-8 position-absolute text-center textoHeader">
                            Perfil
                  ...
                  <li className="nav-item mx-1">
                    ...
                    >
                      ...
                      <Dropdown.Menu className="dropdown-menu-right mt-2 p-2 msgLista" aria-labelledby="dropdownMenuButton">
                              ...
                              Object.keys(this.state.lista_msg).length > 0 ? 
                                ...
                                this.state.lista_msg.map((i) => (
                                  <tr key={i.id} className="w-100 h-100"> 
                                    <td>
                                      <Dropdown.Item className="p-2" onClick={() => this.exibir_msg(i)}>
                                        {i.inicio}
                                      </Dropdown.Item>
                                    </td>
                                  </tr>
